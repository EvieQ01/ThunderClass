...
/*************************************************************************
【函数名称】Client::ToSendCount
【函数功能】获得发送队列中还有多少未发送的信息
【参数】无
【返回值】unsigned int 未发送的信息数量
【开发者及日期】邱亦文 2020-06-11
【更改记录】
    2020-06-18 由邱亦文添加注释
*************************************************************************/
unsigned int Client::ToSendCount(){
    if (m_bIsConnected) {
        return 0;
    }
    else {
